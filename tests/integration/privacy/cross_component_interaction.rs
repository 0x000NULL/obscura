...
impl CrossComponentTest {
    fn new(privacy_level: obscura_core::PrivacyLevel, use_tor: bool) -> Self {
...
mod tests {
    ...
    fn test_dandelion_with_tor() {
        let test = CrossComponentTest::new(obscura_core::PrivacyLevel::High, true);
    ...
    fn test_stealth_addressing_with_metadata_protection() {
        let test = CrossComponentTest::new(obscura_core::PrivacyLevel::High, false);
    ...
    fn test_view_key_with_side_channel_protection() {
        let test = CrossComponentTest::new(obscura_core::PrivacyLevel::Medium, false);
