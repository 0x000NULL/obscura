...
fn test_invalid_message_deserialization() {
    ...
    let invalid_magic = vec![0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 1, 2, 3, 4];
    let result = Message::deserialize(&invalid_magic);
    assert!(matches!(result, Err(MessageError::InvalidMagic)));
    
    // Test with invalid message type
    let invalid_type = vec![0x4f, 0x42, 0x58, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 1, 2, 3, 4];
